    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        <li className="nav-item">
          <Link className="nav-link" onClick={activeLink} aria-current="page" to="/">Home</Link>
        </li>
        <li className="nav-item">
          <Link className="nav-link" onClick={activeLink} to="/about">{props.about}</Link>
        </li>
      </ul>
      ...
      {/* <div className="btn-group mx-2" role="group" aria-label="Basic mixed styles example">
        <button type="button" className="btn btn-outline-danger" onClick={props.toggleModeBackD}>red background</button>
        <button type="button" className="btn btn-outline-warning" onClick={props.toggleModeBackW}>yellow background</button>
        <button type="button" className="btn btn-outline-success" onClick={props.toggleModeBackS}>green background</button>
      </div> */}
